...
const groundInfo = [{
	...
	},
	{
		...
		title: '汉江足球场',
		address: '汉中市城固县干沙河9999号',
		imgUrl: 'https://www.bjxku.com/uploads/images/img/2022/0209/1644400195612187.jpg',
		hot: 'S',
		startTime: '14:00',
		endTime: '20:00',
		isPark: false,
...
export const getGroundInfoById = (id) => {
	const groundInfoItem = groundInfo.find(item => item.id === id)
	// 根据id去markers里找到对应的marker，把marker加入到groundInfoItem里，供后面打开场馆对应的地图时使用
	const marker = markers.find(item => item.id === id)
	groundInfoItem.marker = marker
	return groundInfoItem
}
